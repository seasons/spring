...
import { InventoryStatus, PhysicalProductStatus, ReservationStatus, ReservationPhase, WarehouseLocationType, ProductArchitecture, PhotographyStatus, ProductStatus } from "./globalTypes";
