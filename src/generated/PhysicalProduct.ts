...
import { InventoryStatus, PhysicalProductOffloadMethod, PhysicalProductStatus, ReservationStatus, ReservationPhase, WarehouseLocationType, PhysicalProductDamageType, ProductArchitecture, PhotographyStatus, ProductStatus } from "./globalTypes";
