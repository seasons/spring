...
import { PhysicalProductWhereUniqueInput, InventoryStatus, PhysicalProductStatus, PhysicalProductOffloadMethod, WarehouseLocationType, ProductStatus } from "./globalTypes";
