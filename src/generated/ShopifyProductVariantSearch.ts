...
export interface ShopifyProductVariantSearch_search_data_BrandSearchResultData {
  __typename: "BrandSearchResultData" | "CustomerSearchResultData" | "ProductSearchResultData" | "PhysicalProductSearchResultData";
}
...
export interface ShopifyProductVariantSearch_search_data_ShopifyProductVariantSearchResultData {
  ...
  selectedOptions: ShopifyProductVariantSearch_search_data_ShopifyProductVariantSearchResultData_selectedOptions[] | null;
  title: string | null;
  image: string | null;
}

export type ShopifyProductVariantSearch_search_data = ShopifyProductVariantSearch_search_data_BrandSearchResultData | ShopifyProductVariantSearch_search_data_ShopifyProductVariantSearchResultData;
