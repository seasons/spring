...
export const getProductCreateData: any = (values: any) => {
  ...
  const productsData = {
    ...
    rentalPriceOverride: parseInt(rentalPriceOverride),
    recoupment: parseInt(recoupment),
    secondaryColorCode,
    status,
    tags: tags || [],
    type: productType,
...
export const getProductUpdateData = (values: any) => {
  ...
  return {
    ...
    rentalPriceOverride: rentalPriceOverride ? parseInt(rentalPriceOverride) : null,
    recoupment: recoupment ? parseInt(recoupment) : null,
